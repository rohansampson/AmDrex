...
<body class="grey lighten-4">
    ...
    <div class="mainContainer">
        ...
        <div id="fab_close">
            <a class="btn-floating btn-large waves-effect waves-light red right" href="dashboard_admin.html"><i class="material-icons">close</i></a>
        </div>

        <div class="formContainer card">
            <form class="col s12 l12 m6" id="eventAdd" name="eventAdd" action="eventEdit2.php" onsubmit="return validateForm()" method="post">

                <div class="row">
                    <div class="input-field col s12">
                        <input id="name" type="text" class="validate" name="Event_Name" value="<?php echo "$Event_Name"; ?>">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input id="start_date" placeholder="Pick a date" type="date" class="datepicker" name="Start_Date" value="<?php echo "$Start_Date"; ?>">
                        <label for="start_date">Start Date</label>
                    </div>
                    <div class="input-field col s6">
                        <i class="material-icons prefix">today</i>
                        <input id="end_date" placeholder="Pick a date" type="date" class="datepicker" name="End_Date" value="<?php echo "$End_Date"; ?>">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <input id="users" type="text" class="validate" name="users">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#eventAdd').on('keyup keypress', function(e) {
