...
<body class="grey lighten-4">
    ...
    <div class="mainContainer main">
        ...
        <div class="formContainer card">
            <form class="col s12 l12 m6" name="groupAdd" action="" onsubmit="return validateForm()" method="post">
        ...
        <script>
            function validateForm() {
                ...
                var name = document.forms["groupAdd"]["name"].value;
                if (name == null || name == "") {
                    alert("Name must be filled out");
                    return false;
                }

                var event = document.forms["groupAdd"]["event"].value;
                if (event == null || event == "") {
