...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../../css/admin/eventEdit_admin.css" />
...
<body class="grey lighten-4">
    ...
    <div class="mainContainer">
        <nav class="indigo darken-2 topNavBar">
            ...
            <div class="nav-wrapper">
                <div class="col s12">
                    ...
                    <a href="#!" class="breadcrumb">Edit Event</a>
        ...
        <div class="formContainer card">
            <form class="col s12 l12 m6" action="update.php" method="post" name="eventEdit" onsubmit="return validateForm()">

                <div class="row">
                    <div class="input-field col s12">
                        <input id="name" type="text" class="validate" name="aname">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <input id="start_date" placeholder="Pick a date" type="date" class="datepicker" name="startdate">
                        <label for="start_date">Start Date</label>
                    </div>
                    <div class="input-field col s6">
                        <i class="material-icons prefix">today</i>
                        <input id="end_date" placeholder="Pick a date" type="date" class="datepicker" name="enddate">
    ...
    <script>
        ...
        <script>
            function validateForm() {
                ...
                var name = document.forms["eventEdit"]["name"].value;
                if (name == null || name == "") {
                    alert("Name must be filled out");
                    return false;
                }

                var start_date = document.forms["eventEdit"]["start_date"].value;
                if (start_date == null || start_date == "") {
                    alert("Start Date must be filled out");
                    return false;
                }

                var end_date = document.forms["eventEdit"]["end_date"].value;
                if (end_date == null || end_date == "") {
                    alert("End Date must be filled out");
                        return false;
                }

                var street = document.forms["eventEdit"]["street"].value;
                if (street == null || street == "") {
                    alert("Street must be filled out");
                    return false;
                }

                var city = document.forms["eventEdit"]["city"].value;
                if (city == null || city == "") {
                    alert("City must be filled out");
                    return false;
                }

                var zip = document.forms["eventEdit"]["zip"].value;
                if (zip == null || zip == "") {
                    alert("Zip must be filled out");
                    return false;
                }

                var state = document.forms["eventEdit"]["state"].value;
                if (state == null || state == "") {
                    alert("State must be filled out");
                    return false;
                }

                var users = document.forms["eventEdit"]["users"].value;
                if (users == null || users == "") {
                    alert("Users must be filled out");
                    return false;
                }

                var groups = document.forms["eventEdit"]["groups"].value;
