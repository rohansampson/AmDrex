...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../../css/admin/userAdd_admin.css" />
...
<body class="grey lighten-4">
    ...
    <div class="mainContainer">
        ...
        <div id="fab_close">
            <a class="btn-floating btn-large waves-effect waves-light red right" id="fab_close"><i class="material-icons">close</i></a>
        </div>

        <div class="formContainer card">
            <form class="col s12 l12 m6" name="userAdd" action="" onsubmit="return validateForm()" method="post">
    ...
    <script>
        function validateForm() {
            ...
            var name = document.forms["userAdd"]["name"].value;
            if (name == null || name == "") {
            ...
            var events = document.forms["userAdd"]["events"].value;
            if (events == null || events == "") {
                alert("Events must be filled out");
                    return false;
            }

            var groups = document.forms["userAdd"]["groups"].value;
