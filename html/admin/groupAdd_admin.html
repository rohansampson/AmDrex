...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../../css/admin/groupAdd_admin.css" />
...
<body class="grey lighten-4">
    ...
    <div class="mainContainer main">
        ...
        <div class="formContainer card">
            <form class="col s12 l12 m6" name="groupAdd" action="../../php/groupAdd.php" onsubmit="return validateForm()" method="post">

                <div class="row">
                    <div class="input-field col s12">
                        <input id="Group_Name" name="Group_Name" type="text" class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="Event_ID" name="Event_ID" type="text" class="validate">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label for="myCheckbox">
                                            <td>Create</td>
                                            <td>
                                                <input type="checkbox" id="myCheckbox1" class="filled-in" />
                                                <label for="myCheckbox1">
                                                </label>
                                            </td>
                                            <td>Edit</td>
                                            <td>
                                                <input type="checkbox" id="myCheckbox2" class="filled-in" />
                                                <label for="myCheckbox2">
                                                </label>
                                            </td>
                                            <td>Delete</td>
                                            <td>
                                                <input type="checkbox" id="myCheckbox3" class="filled-in" />
        ...
        <script>
            function validateForm() {
                ...
                var name = document.forms["groupAdd"]["Group_Name"].value;
                if (name == null || name == "") {
                    alert("Name must be filled out");
                    return false;
                }

                var event = document.forms["groupAdd"]["Event_ID"].value;
                if (event == null || event == "") {
                    alert("Event must be filled out");
                    return false;
                }

                var users = document.forms["groupAdd"]["users"].value;
                if (users == null || users == "") {
